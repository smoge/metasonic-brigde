...
usage prog = unlines
  ...
  , "  " <> prog <> " --manifest-live-session MANIFEST.json DEMO [--strategy STRATEGY]"
  ...
  , "                     require-preserving ->"
  , "                       supervised stack with"
  , "                       realPreservingHostStackOps (preserving-"
  , "                       only; no fallback composition; every"
  , "                       live-fallback rejection surfaces as"
  ...
  , "                   unchanged."
  , "  --manifest-live-session MANIFEST.json DEMO [--strategy STRATEGY]"
  , "                   Phase 8 v0 manifest-backed live session shell. Open-"
  ...
  , "                       "
      <> intercalate ", " manifestReloadHostStrategyNames
  , "                   --strategy is recognized ONLY for this command;"
  , "                   it does not affect --manifest-live-reload-demo or"
  , "                   --manifest-host-reload-smoke, which take their"
  ...
  , "                   Also used by --manifest-live-reload-demo and"
  , "                   --manifest-live-session for the OSC ingress"
  , "                   listener bind port. Default is 7001."
  , "                   Ignored by other modes."
