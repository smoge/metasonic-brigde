...
# Marker checks. Each row maps to one of the six acceptance
# markers (or a sub-fact for compound markers). Exit non-zero
...
check_marker "1.  supervised route selected" \
  "$TRANSCRIPT" "route: supervised (reloadSupervised + HostStackFactory)"
