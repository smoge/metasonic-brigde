...
unitTests = testGroup "Unit tests"
  ...
  , -- Phase 4.C: fusion algebra and its preconditions. The Step B
    -- pins ('rnOutputUse', 'rnConsumerCount') feed the single-edge
    -- fusion gate; the 'fuseRuntimeGraph' tests pin the gate itself
    -- and the 'FScaleFrom' / 'FScaleChainFrom' / 'FAffineFrom'
    -- algebras. Awaiting extraction into MetaSonic.Spec.Core.FusionAlgebra.
