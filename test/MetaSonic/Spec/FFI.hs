...
-- Phase 4.E.2.C0d global-schedule runnable bands tests now live in
-- "MetaSonic.Spec.FFI.C0d".
--
-- Phase 4.E.2.C1c-c worker-schedule equivalence tests now live in
-- "MetaSonic.Spec.FFI.C1c". The helpers below ('compileBoth',
-- 't9CorpusGraphs', etc.) are still exported from this module and
-- imported by the submodules.
